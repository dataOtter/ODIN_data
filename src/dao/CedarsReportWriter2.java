 ...
 *
 */
public class CedarsReportWriter2 {
	...
	public CedarsReportWriter2(ReportsCollection reps, String path, int formatVersion) {
        _path = path;
	...
	private IMJ_Map<String, IMJ_OC<String>> makeFinalTagsAndGetTagToDescr(int studyId) {
		...
		onlyAddTheseTags.add("all things for today"); 
